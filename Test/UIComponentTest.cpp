...
namespace {
    ...
    {
        component->right(Point(0,0), 500, 500);
    ...
    {
        component->left(Point(0,0), 500, 500);
    ...
    {
        component->params.marginLeft = 200;
        component->position = Point(100, 200);
    ...
    {
        component->params.marginTop = 200;
        component->position = Point(200, 100);
    ...
    TEST_F(UIComponentTest, ReadjustMarginTopLeft)
    {
        component->params.marginTop = 200;
        component->params.marginLeft = 200;
        component->position = Point(100, 100);
